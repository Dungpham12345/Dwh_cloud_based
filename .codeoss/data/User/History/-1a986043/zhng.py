...
with DAG(
    ...
    test_conn >> extract_data >> upload_all_tables >> [transform_job, transform_employee, transform_department, transform_candidate, transform_candidate_log] >> save_transformed
