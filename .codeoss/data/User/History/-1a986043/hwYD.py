...
def create_upload_tasks(bucket_name, project_id, dataset_name, dag, gcs_prefix="data/dwh"):
    ...
    for blob_path in gcs_files:
        table_name = Path(blob_path).stem  # chính xác hơn, không trùng
...
with DAG(
    ...
    transform_pic_tracking_table = Python
    ...
    test_conn >> extract_data >> upload_all_tables >> [
    transform_job, transform_employee, transform_department,
    transform_candidate, transform_candidate_log
